...
public class MyLocalServerReceiver implements VerificationCodeReceiver {
     ...
     */
    public MyLocalServerReceiver(String host, int port, String successLandingPageUrl, String failureLandingPageUrl) {
    ...
    public static final class Builder {
        ...
        public MyLocalServerReceiver build() {
            return new MyLocalServerReceiver(host, port, callbackPath, successLandingPageUrl, failureLandingPageUrl);
        }
